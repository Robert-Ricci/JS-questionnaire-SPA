...
Question.create(text:" 1) You’re in the cafeteria and it is time for school store. You’re a Positive and you brought a dollar so you can get a snack. However someone at your table is a Neutral and can’t get their own snacks. They pass you their dollar to buy a snack for them. What do you do?",
     choices:["A -You say no. Go to the school store and share your snack with the Neutral who wasn’t allowed to buy their own.",
     ...
     "D- You take their dollar and buy yourself a snack, which is their fault anyway because they should have their rating up."], selection:""
)

# Question.create(text:" 2) You’re taking a test in Mr. B’s room. The desks are in testing formation so no one can cheat. However you notice the student in front of you does have their test on the desk in just a way that you can make out the correct multiple choice answers. What do you do?",
#     # choices:["A -You notice that the student has one of the answers wrong and you try to signal them so they can change it to the correct answer.",
...
# Question.create(text:" 3) At gym you over hear a group of students talking about someone else. They’re saying nasty things and talking about jumping that student in the cafeteria or on the bus. What do you do?",
#     # choices:["A- You mind your own business. Stay out of it. And you get a good seat in the cafeteria to watch the fight go down.",
...
# Question.create(text:" 4) You're in line, in the hallway, during bathroom break. The students in front of you are talking. Mr. Graham is talking to them about what they did over the weekend. What do you do?",
#     # choices:["A- You add what you did over the weekend to their conversation because your were awesome at Fortnight and you want to share. Besides, Mr. Graham is a teacher and if he is talking then it probably isn't a big deal",
...
# Question.create(text:" 5) You're doing iLit in Mr. Shazer's classroom. His instruction was for you to complete your Interactive Reader and when you're finished with that you are expected to complete one of the grammar lessons. You scored a four on your Interactive Reader and Mr. Phillips just shouted 'Five minutes!'",
#     # choices:["A- You go to Cool Math and start playing Running Man. There is only five minutes left. You finished your Interactive Reader and got a four.", 
...
# Question.create(text:"6) It is lunch time, Mr. Johns and Mr. Parks are in the cafeteria. They're talking and laughing with each other. You hear Mr. John's cuss. His voice is low and no one else heard it. Then he does it again. Mr Parks would have heard it too. However he is laughing at Mr. Johns' story.", 
#     # choices:["A -You turn to the other students at the table and tell them what you heard. Together you tease Mr. Johns for being a teacher and breaking a norm.",
...
# Question.create(text:"7) It is early in the morning and you are on the bus with your head down. You are trying to sleep when you smell something. It is weed. Someone on the bus is smoking weed.",
#     # choices:["A - You're not at school yet, you stick your head up and look to see if you can find out who is smoking. You find it and take a puff. Just one because you're not even at school yet.", 
...
# Question.create(text:"8) You're in the classroom during group, but the speaker had to step out into the hallway because of an emergency call on her cell phone. You happen to notice that Mr. K's wallet is hanging out of the pocket of his jacket. He isn't in the room either. No one would see you if you took it. ", 
#     # choices:["A - No one is in the room so you get up and grab the wallet. You take out the cash and put it in your pocket. No one saw knows what you did so you're not going to get caught.", 
...
# Question.create(text:"9) Ms. Hill is running school store. You don't have enough for chips, candy, and an iced tea. She offers to let you have the tea but you have to pay her for it tomorrow.", 
#     # choices:["A - You take advantage of Ms. Hill's offer. You take the candy, chips, and iced tea but you're not going to bring in the money. It is her fault. She shouldn't offer free stuff and expect you to pay for it.",
...
# Question.create(text:"10) You're in class and a student is being disrespectful. They're cussing and not accepting redirection. The teacher is going up his levels and is now escorting the student out in the hallway.",
#     # choices:["A - You laugh at the student and make fun of them. “You're going to get into a hold,” is what you tease the student with.", 
